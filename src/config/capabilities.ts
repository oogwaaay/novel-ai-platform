...
export const CAPABILITY_PROFILES: Record<Exclude<SubscriptionTier, 'free'>, CapabilityProfile> = {
  starter: {
    ...
    description: 'Launch your first AI-assisted manuscript - good for ~1 short novel',
    ctaLabel: 'Get started',
    features: [
      'Limited Writing (300 Generations / month)',
      '5,000 Points / month (For AI Art & Advanced Features)',
  ...
  pro: {
    ...
    features: [
      'Unlimited Writing (Text Generation)',
      '2,000 Points / month (For AI Art & Advanced Features)',
  ...
  unlimited: {
    ...
    features: [
      'Unlimited Writing (Text Generation)',
      '10,000 Points / month (For AI Art & Advanced Features)',
      'Access to DeepSeek Models',
      'Everything in Pro',
